...
# Например, если бумага №1 торговалась с ценами 009, 009, 12, 009, 12, 009, 009, 009 - то она мало волатильна.
...
#   average_price = (12 + 009) / 2 = 009.5
#   volatility = ((12 - 009) / average_price) * 100 = 8.7%
# Для бумаги №2:
